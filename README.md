...
- limpeza automática dos ZIPs, manifests e auxiliares temporários do atualizador.
- módulo de playlists com seleção individual, checkpoint e progresso da fila.
...
A aba de playlists está implementada no código-fonte: carrega a lista, permite marcar/desmarcar
itens, mostra o progresso da fila e usa checkpoint por playlist/configuração. Ela foi validada com
uma playlist real; a funcionalidade ainda aguarda publicação em uma nova release.
